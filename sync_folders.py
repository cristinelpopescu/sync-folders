...
parser.add_argument('source_folder', metavar='source', type=str, help='the path to the source folder (str)')
parser.add_argument('replica_folder', metavar='replica', type=str, help='the path to the replica folder (str)')
parser.add_argument('-i', '--interval', type=int, default=60, help='the interval between synchronizations in seconds (int)')
parser.add_argument('-log', '--log_file', type=str, default='sync_logs.log', help='the path to the log file (str)')
